...
% Vectorized Implementation
      ...
      % corrupting 50% of the data
      corrupt_array = randperm(n,floor(n/2))';
      a1(corrupt_array,1)=0; 
      for c=2:m
         corrupt_array = randperm(n,floor(n/2))' ;
         a1(corrupt_array,c)=0; 
      end
...
%       z3 = W2 * a2 + b2; % 64x1
      ...
      sqrd_error = sum((a3-a1_original).^2);
...
%       sparsityParam_obtained = sparsityParam_obtained + a2;
  ...
  delta3 = -(a1_original-a3).*sigmoid(z3).*(1-sigmoid(z3)); %64 x m
